...
const services = [
  {
    ...
    description: "End-to-end web applications built with modern frameworks like Next.js, React 19, TypeScript, and scalable backend architectures.",
  },
  {
    icon: Palette,
    title: "UI/UX & Design Systems",
    description: "Designing intuitive, accessible, and stunning interfaces with Tailwind CSS and fluid motion that prioritize user experience.",
  },
  {
    icon: Cpu,
    title: "AI & Machine Learning",
    description: "Engineering intelligent models, neural networks, PyTorch & CUDA acceleration, and autonomous multi-agent pipelines.",
  },
  {
    icon: Layers,
    title: "Systems & Data Architecture",
    description: "Designing scalable relational and vector databases (PostgreSQL, Supabase, Redis), REST APIs, and worker queues.",
  }
];
