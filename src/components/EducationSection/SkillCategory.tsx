...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "Python & PyTorch", level: 95, icon: Atom, color: "text-cyan-400" },
    { name: "TypeScript & React / Next.js", level: 92, icon: Server, color: "text-emerald-400" },
    { name: "C++ & Systems Programming", level: 90, icon: Code2, color: "text-blue-400" },
    { name: "PostgreSQL & Data Engineering", level: 88, icon: Database, color: "text-amber-400" },
    { name: "Cloud & DevOps (Docker, Azure)", level: 85, icon: Cloud, color: "text-purple-400" },
  ];
  ...
  const softSkills = [
    ...
    { name: "Critical Thinking", icon: HeartHandshake, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
