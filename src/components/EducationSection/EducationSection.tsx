...
import { GraduationCap, BookOpen, CheckCircle2, Calendar, Building2 } from "lucide-react";
  ...
  const education = [
    {
      ...
      school: "University of Westminster (UK) — at IIT Colombo",
      year: "Reading · Expected 2028",
      icon: GraduationCap,
      details: [
        "Focus on Artificial Intelligence, Machine Learning & Systems Architecture",
        "Rigorous foundation in Data Structures, Algorithms & Distributed Computing",
        "Designing scalable databases and end-to-end intelligent applications",
        "Delivered at the Informatics Institute of Technology (IIT), Colombo"
      ]
    },
    {
      degree: "AI, ML & Data Science Specializations",
      school: "Microsoft & IBM (Coursera)",
      year: "2025 · Certified",
      icon: BookOpen,
      details: [
        "Microsoft AI & ML Engineering Specialization: Applied AI, neural networks & cloud solutions",
        "IBM Data Science Professional Certificate: End-to-end data pipelines, SQL & predictive models",
        "IBM Applied Data Science Specialization: Practical analysis, statistical modeling & visualization",
        "Hands-on production machine learning workflows and deep learning architectures"
      ]
    }
  ];
